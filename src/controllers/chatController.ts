...
// @access  Private/Admin
export const getUserMessagesByUserId = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  ...
  await ChatMessage.updateMany({ userId, isUser: true, isRead: false }, { isRead: true })
...
// @access  Private/Admin
export const sendAdminMessage = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const markMessagesAsRead = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  ...
  await ChatMessage.updateMany({ userId, isUser: false, isRead: false }, { isRead: true })
...
// @access  Private/Admin
export const markAdminMessagesAsRead = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  const { userId } = req.params
